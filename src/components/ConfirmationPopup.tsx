    ...
    <div className="fixed inset-0 bg-white flex items-center justify-center z-50">
      <div className="bg-white border border-gray-300 shadow-lg rounded-sm w-96 p-6">
        ...
        <div className="flex justify-end space-x-2 mt-6">
          <button
            onClick={onAction}
            className="px-4 py-2 bg-white border border-gray-300 text-gray-700 text-sm hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-blue-500"
          >
            Leave
          </button>
          <button
            onClick={onAction}
            className="px-4 py-2 bg-blue-600 text-white text-sm hover:bg-blue-700 focus:outline-none focus:ring-1 focus:ring-blue-500"
          >
            Cancel
          </button>
        </div>
